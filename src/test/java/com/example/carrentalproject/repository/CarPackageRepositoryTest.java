...
//
//Test Case Purpose: Verify that findByPackageName() correctly retrieves CarPackage entities by name.
//
//
//        Annotations:
                        //@DataJpaTest: Sets up a JPA-focused test.
                        //@AutoConfigureTestDatabase(replace = NONE): Uses the real database configuration.
                        //@Autowired: Injects CarPackageRepository.
                        //@BeforeEach: Prepares test data before each test.
                        //@AfterEach: Cleans up data after each test.
